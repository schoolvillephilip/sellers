                                                                ...
                                                                <div class="panel-collapse collapse in" id="general-info">
                                                                    <div class="panel-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-7">
                                                                                <select class="form-control selectpicker" name="brand_name" required="" data-width="100%">
                                                                                    ...
                                                                                    <?php endforeach; ?>
                                                                                    <option value="others" <?php if($product->brand_name == 'others') echo 'selected' ?> >Others</option>
                                                                                </select>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-7">
                                                                                <input type="text" class="form-control" name="main_colour" value="<?= ucfirst($product->main_colour); ?>" placeholder="Eg: royal blue, mint green, Peach red">
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <tr data-row-id="<?= $x; ?>">
                                                                        <td>
                                                                            <div class="form-group-sm col-md-12">
                                                                                ...
                                                                                <?php else :?>
                                                                                    <input title="variation" type="text" value="<?= $variation->variation; ?>"
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group-sm">
                                                                                ...
                                                                                <input title="Starting date for this discount" data-provide="datepicker" data-date-format="yyyy/mm/dd" placeholder="yyyy/mm/dd" class="form-control datepicker" name="start_date[]" value="<?php if(!empty($variation->start_date)) echo date('Y/m/d', strtotime($variation->start_date)); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group-sm">
                                                                                <label class="">Discount End Date</label>
                                                                                <input title="Ending date for this discount" data-provide="datepicker" data-date-format="yyyy/mm/dd" placeholder="yyyy/mm/dd" class="form-control datepicker" name="end_date[]" value="<?php if(!empty($variation->end_date)) echo date('Y/m/d', strtotime($variation->end_date)); ?>" />
                                                                            </div>
                                                                        </td>
                                                                        <td class="">
                                                                            <div class="btn-group">
                                                                            ...
                                                                            <div class="media-body">
                                                                                ...
                                                                                <div class="media-block">
                                                                                    ...
                                                                                    <div class="media-body">
                                                                                        ...
                                                                                        <span class="dz-error text-dark text-sm" data-dz-errormessage></span>
