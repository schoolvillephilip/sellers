                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li <?php if($pg_name == 'product' || $pg_name == 'manage_product' ) echo 'class="active"'?>>
                            ...
                            <ul class="collapse <?php if($pg_name == 'product' || $pg_name == 'manage_product') echo 'in';?>">
                                <li <?php if($sub_name =='select_category') echo 'class="active-link"' ?>><a href="<?= base_url('product'); ?>">
                                        <i class="demo-pli-file-zip"></i>Select Category</a></li>
                                <li <?php if($sub_name == 'add_product') echo 'class="active-link"' ?>><a href="<?= base_url('product/create'); ?>">
                        ...
                        <li <?php if($pg_name == 'orders') echo 'class="active"'?>">
                            ...
                            <ul class="collapse <?php if($pg_name == 'orders') echo 'in';?>">
                                <li <?php if($sub_name =='all') echo 'class="active-link"' ?>><a href="<?= base_url('orders/')?>">
                                        <i class="demo-pli-shopping-cart"></i>All Orders</a></li>
                                <li <?php if($sub_name =='order_pending') echo 'class="active-link"' ?>><a href="<?= base_url('orders/?type=pending')?>">
                                        <i class="demo-pli-file-add"></i>Pending Orders</a></li>
                                <li <?php if($sub_name =='order_shipped') echo 'class="active-link"' ?>><a href="<?= base_url('orders/?type=shipped')?>">
                                ...
                                <li>
                                    ...
                                    <!--Submenu-->
                                    <ul class="collapse">
                                        <li <?php if($sub_name =='order_delivered') echo 'class="active-link"' ?>><a href="<?= base_url('orders/?type=delivered')?>">
                                                <i class="demo-pli-data-storage"></i>Delivered</a></li>
                                        <li <?php if($sub_name =='order_canceled') echo 'class="active-link"' ?>><a href="<?= base_url('orders/?type=canceled'); ?>">
                                                <i class="demo-pli-remove"></i>Canceled</a></li>
                                        <li <?php if($sub_name =='order_failed_delievery') echo 'class="active-link"' ?>><a href="<?= base_url('orders/?type=failed_delivery'); ?>">
                                                <i class="demo-pli-mail-remove"></i>Failed Delivery</a></li>
                                        <li <?php if($sub_name =='order_retured') echo 'class="active-link"' ?>><a href="<?= base_url('orders/?type=returned'); ?>">
                        ...
                        <li class="<?php if($pg_name == 'settings') echo 'class="active"'?>">
                            ...
                            <ul class="collapse <?php if($pg_name == 'settings') echo 'in';?>">
                                <li <?php if($sub_name =='profile') echo 'class="active-link"' ?>><a href="<?= base_url('settings')?>">
                                        <i class="demo-pli-add-user-star"></i>Profile</a></li>
                                <li <?php if($sub_name =='change_password') echo 'class="active-link"' ?>><a href="<?= base_url('settings/change_password'); ?>">
