...
<link href="<?= base_url('assets/seller/plugins/bootstrap-datepicker/bootstrap-datepicker.min.css') ?>"
      rel="stylesheet">
</head>
<body>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="carrito-tabs-box-1">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="tin" value="<?= $profile->tin; ?>"
                                                       id="carrito-tin-name"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="reg_no" value="<?= $profile->reg_no; ?>"
                                                       id="carrito-brn-name"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="demo_select2 form-control" name="license_to_sell">
                                                    ...
                                                    <option value="1" <?php if ($profile->license_to_sell == 1) echo 'selected' ?> >
                                                        Yes
                                                    </option>
                                                    <option value="0" <?php if ($profile->license_to_sell == 0) echo 'selected' ?> >
                                                        No
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="demo_select2 form-control" name="no_of_products">
                                                    ...
                                                    <option value="101-500" <?php if ($profile->no_of_products == "101-500") echo 'selected'; ?> >
                                                        101-500
                                                    </option>
                                                    <option value="501-2000" <?php if ($profile->no_of_products == "501-2000") echo 'selected'; ?> >
                                                        501-2000
                                                    </option>
                                                    <option value="2000-5000" <?php if ($profile->no_of_products == "2000-5000") echo 'selected'; ?> >
                                                        2001-5000
                                                    </option>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" required name="bvn" value="<?= $profile->bvn; ?>"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" required name="account_name"
                                                       value="<?= $profile->account_name; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" required name="account_number"
                                                       value="<?= $profile->account_number; ?>" class="form-control">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control"
                                                              name="terms"><?= cleanit($profile->terms); ?></textarea>
                                                </div>
                                            </div>
